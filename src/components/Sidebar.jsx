    ...
    return (
        <>
          <div className="container mx-auto my-60">
            <div>
               <div className="bg-white relative shadow rounded-lg w-5/6 md:w-3/6 lg:w-3/6  xl:w-2/6 mx-auto">
...
<div className="mt-16">
    ...
    <p className='text-center text-sm text-gray-400 font-medium'>Fullstack Software Developer</p>
</div>
<span>

</span>
<div className="my-5 px-6">
<a href="#" class="text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-3 bg-gray-900 hover:bg-black hover:text-white">Connect with <span class="font-bold">@geoffreynjihi10</span></a>
</div>
<div class="flex justify-between items-center my-5 px-6">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-5 w-full flex flex-col items-center overflow-hidden text-sm">
                            <a href="#" class="w-full border-t border-gray-100 text-black-600 py-4 pl-6 pr-3 w-full block hover:bg-gray-100 transition duration-150">
                            ...
                            <a href="#" class="w-full border-t border-gray-100 text-black-600 py-4 pl-6 pr-3 w-full block hover:bg-gray-100 transition duration-150 overflow-hidden">
                                <img src="https://avatars0.githubusercontent.com/u/35900628?v=4" alt="" class="rounded-full h-6 shadow-md inline-block mr-2"/>
                                Added new rank
