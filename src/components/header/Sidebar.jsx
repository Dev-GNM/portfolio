    ...
    return (
        <>
            <div className="container relative mx-auto my-60">
                <div>
                    <div className="bg-white inset-y-0 shadow rounded-lg w-5/6 md:w-3/6 lg:w-3/6  xl:w-2/6 mx-auto">
                        ...
                        <div className="flex justify-center pt-4 space-x-4 align-center">
                            ...
                            <a rel="noopener noreferrer" href="#" aria-label="LinkedIn" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                ...
                <div>
                <div className=" container flex justify-center ml-10 mt-7">
